...
const log = Log.module('deephaven-plugin-ptt-input.DeephavenPluginPttInputView');
...
export function DeephavenPluginPttInputView(props: WidgetComponentProps): JSX.Element {
  const { fetch } = props;
